...
| **Редактор приятеля** | Полный редактор статистики, навыков, IV, ранга, душ, пола, переключения босса/счастливчика |
...
| Инструмент | Описание |
|------|-------------|
| **Редактировать друзей игроков** | Полноценный редактор приятелей со статистикой, навыками, IV, талантами, душами, рангом и полом |
| **Конвертер SteamID** | Преобразование идентификаторов Steam в UID Palworld |
...
**Результат:**
- Игрок Б теперь является хозяином со своим персонажем и друзьями в `0001.sav`.
...
**Решение:**
1. Закройте версию Palworld GamePass.
...
- **Раздор:** [Join us for support, base builds, and more!](https://discord.gg/sYcZwcT4cT)
- **Проблемы с GitHub:** [Report a bug](https://github.com/deafdudecomputers/PalworldSaveTools/issues)

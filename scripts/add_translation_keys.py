...
NEW_TRANSLATIONS = {'pal_editor.tab': 'Pal Editor', 'pal_editor.title': 'Pal Editor', 'pal_editor.select_player': 'Select Player', 'pal_editor.search_players': 'Search players...', 'pal_editor.select_player_hint': 'Select a player from the dropdown to edit their pals', 'pal_editor.editor': 'Editor', 'pal_editor.open_editor': 'Open Pal Editor', 'inventory.search_players': 'Search players...', 'inventory.select_player': 'Select Player'}

...
def update_container_ids_for_player(player_uid, parent=None):
    ...
    try:
        ...
        return False
def get_item_economy_stats(item_id, parent=None):
    if not constants.loaded_level_json:
        return None
    try:
        from palworld_aio.base_inventory_manager import find_item_locations_efficient
        ...
        traceback.print_exc()
        return None
def remove_item_from_guilds(item_id, percentage=None, parent=None):
    if not constants.loaded_level_json:
